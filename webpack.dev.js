...
const endpointMap = {
  prod: "http://localhost:9000/payments",
  sandbox: "http://localhost:9000/payments",
  integ: "http://localhost:8080/api/payments",
  local: "http://localhost:9000/payments", // Default or local environment endpoint
};
